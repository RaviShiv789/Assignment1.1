...
returned_value = function_definitions.my_addition(first_num,second_num)
print("The Addition of the numbers is ",returned_value)

returned_value = function_definitions.my_square(first_num)
print("The Square of the number is ",returned_value)

returned_value = function_definitions.my_exponenation(first_num,second_num)
print("The exponenation of the numbers is ",returned_value)

my_string = input("Please enter a String: ")
returned_value = function_definitions.my_uppercase_func(my_string)
...
returned_value= function_definitions.raise_sal_percent(existing_salary,raise_salary_percentage)
print("The incremented salary is ",returned_value)

height = int(input("Pleased enter height in cms "))
returned_value= function_definitions.get_height(height)
print("Height in feet is ",returned_value)

no_of_dollars = int(input("Pleased enter no of dollars "))
returned_value= function_definitions.convert_to_rupee(no_of_dollars)
...
returned_value=function_definitions.get_fare_details(source, destination, fare, discount_rate)
